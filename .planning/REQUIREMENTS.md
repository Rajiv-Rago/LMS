...
- [x] **CATL-03**: User can enroll in a course from the catalog with one click (redirects to login if needed)
- [x] **CATL-04**: Courses have shareable URLs with Open Graph metadata for link previews

### Inline Feedback

- [x] **FDBK-01**: Learner can submit feedback on a lesson (text input describing the issue)
...
- [x] **FDBK-04**: Feedback UI is visible and discoverable (not hidden in a collapsed accordion)
- [x] **FDBK-05**: Regeneration has rate limiting to prevent cost abuse

### Visual Polish

- [x] **VISL-01**: Loading states use consistent skeleton screens across all pages
...
| FDBK-01 | Phase 5: Inline Feedback | Complete |
...
| VISL-01 | Phase 6: Visual Polish | Complete |
