          ...
          >
            ...
            <div className="flex-1 min-w-0">
              <a
                ...
                className="text-sm font-medium text-zinc-900 dark:text-white hover:text-indigo-600 dark:hover:text-indigo-400 truncate block"
              >
                {file.originalName}
              </a>
...
function FileIcon({ type }: { type: string }) {
  ...
  switch (type) {
    ...
    case "video":
      return (
        <svg className={`${iconClasses} text-violet-600`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
